...
function Warn() {
  return (
    ...
    <div className="flex flex-col gap-8 py-14 border-t-[1px] border-[#DDDDDD]">
      <div className="h-20 w-20 rounded-full border-4 border-black bg-[#D9D9D9]"></div>
  ...
  return (
    ...
    <>
      <section className="container mx-auto gap-40 items-center flex-col relative flex py-40">
        <div className="text-[2.5em] font-[900] text-center ">
          하우스백

          <h3 className="text-[2.5rem] font-[900] text-center">사용시 주의사항</h3>
        </div>
        <div className="grid grid-cols-2 gap-x-40 w-[80%]">
          <Warn></Warn>
          <Warn></Warn>
          <Warn></Warn>
          <Warn></Warn>
